...
// 1. Pengajuan with status 'Menunggu Verifikasi'
...
// 4. Total Detail Pembayaran (Sudah Bayar)
...
$sql_chart = "SELECT id_pengujian FROM pengujian";
...
<head>
    ...
    <style>
        * {
        ...
        .approve-btn ion-icon, .reject-btn ion-icon {
            font-size: 16px;
            color: var(--white);
        }
            ...
            <ul>
                ...
                <li>
                    <a href="penerimaan.php">
                        <span class="icon">
                            <img src="../assets/document-text.png" alt="penerimaan">
                        </span>
                ...
                <li>
                    <a href="proses_uji.php">
                        <span class="icon">
                            <img src="../assets/sync.png" alt="proses_uji">
                        </span>
                ...
                <li>
                    <a href="riwayat_uji.php">
                        <span class="icon">
                            <img src="../assets/history.png" alt="riwayat_uji">
                        </span>
        ...
        <div class="main">
            ...
            <?php if ($error_message): ?>
                <div class="overlay" id="messageOverlay" style="display: block;">
                    <div class="message-box <?php echo ($error_message == 'status_updated' || $error_message == 'pengujian_deleted') ? '' : 'error'; ?>">
                        <span class="close-btn" onclick="hideAlert()">×</span>
                        <img src="../assets/<?php echo ($error_message == 'status_updated' || $error_message == 'pengujian_deleted') ? 'success.png' : 'peringatan.png'; ?>" alt="<?php echo ($error_message == 'status_updated' || $error_message == 'pengujian_deleted') ? 'success' : 'warning'; ?>">
                        <p>
                            <?php
                            if ($error_message == 'status_updated') {
                                echo "Status pengujian berhasil diperbarui!";
                                ...
                                echo "Status pengujian tidak valid.";
                            } elseif ($error_message == 'database_error') {
                                echo "Terjadi kesalahan pada database.";
                            } elseif ($error_message == 'pengujian_not_found') {
                                echo "Pengujian tidak ditemukan.";
                            } else {
                                echo "Terjadi kesalahan saat memproses pengujian.";
                            }
                            ?>
                        </p>
                    </div>
            ...
            <div class="details">
                        ...
                        <div class="pagination">
                            ...
                            for ($i = 1; $i <= $totalPagesPengujian; $i++) {
                                if ($i == $page_pengujian) {
                                    ...
                                    echo "<a href='beranda.php?page_pengujian=$i'>$i</a>";
                                }
                            }
                            ?>
                        </div>
                ...
                <div class="right-column">
                    <div class="approval-card">
                        <h3>Persetujuan Penerimaan Pengujian</h3>
                        <div class="approval-list">
                            ...
                            $query = "SELECT id_pengajuan, nama_pasien, tanggal_pengajuan 
                                      FROM pengajuan 
                            ...
                            if ($result5 && $result5->num_rows > 0) {
                                while ($row = $result5->fetch_assoc()) {
                                    $tanggal_pengajuan = !empty($row['tanggal_pengajuan']) ? date('Y/m/d', strtotime($row['tanggal_pengajuan'])) : '-';
                            ?>
                                    <div class="approval-item">
                                        <div class="info">
                                            <div class="name"><?php echo htmlspecialchars($row['nama_pasien']); ?></div>
                                            <div class="date"><?php echo $tanggal_pengajuan; ?></div>
                                        </div>
                                        <div class="actions">
                                            <form action="konfirPengajuan.php" method="post" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menyetujui pengajuan ini?');">
                                            ...
                                            <form action="konfirPengajuan.php" method="post" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menolak pengajuan ini?');">
                                                <input type="hidden" name="id_pengajuan" value="<?php echo $row['id_pengajuan']; ?>">
                            ...
                            <?php
                                ...
                                echo "<div class='text-center text-gray-400'>Tidak ada permintaan</div>";
                            }
                            ?>
                        </div>
                        <div class="pagination">
                            ...
                            for ($i = 1; $i <= $totalPages; $i++) {
                                if ($i == $page) {
                                    ...
                                    echo "<a href='beranda.php?page=$i'>$i</a>";
                                }
                            }
                            ?>
                        </div>
