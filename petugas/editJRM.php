...
<body>
  <div class="form-container">
    ...
    <form action="proseseditJRM.php" method="post">
      ...
      <div class="form-group">
        <label for="alamat">Mikroskopis<span style="color:red">*</span></label>
        <textarea id="mikroskopis" name="mikroskopis" required><?php echo htmlspecialchars($data['mikroskopis']); ?></textarea>
      </div>
