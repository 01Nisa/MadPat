...
?>
  ...
  <div class="container">
    ...
    <div class="section">
      <div class="label">Pemeriksaan Jaringan Tubuh</div>
      <table>
        <tr>
          <td>Jaringan didapat dengan</td><td>:</td>
          <td><?= htmlspecialchars($data['diambil_dengan'] ?? '-') ?: '-' ?></td>
        </tr>
        <tr>
          <td>Berasal dari</td><td>:</td>
          <td><?= htmlspecialchars($data['asal_jaringan'] ?? '-') ?: '-' ?></td>
        </tr>
        <tr>
          <td>Direndam dalam</td><td>:</td>
          <td><?= htmlspecialchars($data['perendaman'] ?? '-') ?: '-' ?></td>
        </tr>
        <tr>
          <td>Diagnosis Klinik</td><td>:</td>
          <td><?= htmlspecialchars($data['diagnosis_klinik'] ?? '-') ?: '-' ?></td>
        </tr>
      </table>
    </div>

    <div class="section">
      <div class="label">Keterangan Penyakit Penderita</div>
      <p>Apakah terdapat Helicobacter pylori?</p>
      <table>
        <tr>
          <td>Pemeriksaan Patologi</td><td>:</td>
          <td><?= htmlspecialchars($data['pemeriksaan_patologi'] ?? '-') ?: '-' ?></td>
        </tr>
        <tr>
          <td>Nomor Pemeriksaan</td><td>:</td>
          <td><?= htmlspecialchars($data['nomor_pemeriksaan'] ?? '-') ?: '-' ?></td>
        </tr>
        <tr>
          <td>Tanggal Pemeriksaan</td><td>:</td>
          <td><?= htmlspecialchars($data['tanggal_pemeriksaan'] ?? '-') ?: '-' ?></td>
        </tr>
        <tr>
          <td>Diagnosis Pemeriksaan</td><td>:</td>
          <td><?= htmlspecialchars($data['diagnosis_pemeriksaan'] ?? '-') ?: '-' ?></td>
        </tr>
      </table>
    </div>
